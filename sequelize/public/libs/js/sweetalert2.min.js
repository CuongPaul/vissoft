!(function (t, e) {
  ...
  function it(t) {
    $e.isVisible() && ct !== t.target.value && $e.resetValidationMessage(),
      (ct = t.target.value);
  }
  function rt(t, e) {
  ...
  var _t = {},
    ...
    Kt = { animation: 'showClass" and "hideClass' },
    Yt = [
      'allowOutsideClick',
      'allowEnterKey',
      'backdrop',
  ...
  var Gt = function () {
    ...
    te = { swalPromiseResolve: new WeakMap() };
  function ee(t, e, n, o) {
    n
      ? re(t, o)
      : (Rt().then(function () {
  ...
  var ie = function (t, e, n, o) {
      (_t.swalCloseEventFinishedCallback = ee.bind(null, t, n, K(), o)),
  ...
  var we = function (t, e) {
      ht && et(e)
        ? ((t.style.overflowY = 'hidden'),
          e.addEventListener(ht, de.bind(null, e, t)))
        ...
        ? (e.disableInput(),
          Promise.resolve()
            ...
            .then(function (t) {
              e.enableButtons(),
                e.enableInput(),
                t ? e.showValidationMessage(t) : Oe(e, n, o);
            }))
    ...
    Oe = function (e, t, n) {
      (t.showLoaderOnConfirm && qt(), t.preConfirm)
  ...
  var Ye,
    Ze = Object.freeze({
      ...
      _main: function (t) {
        !(function (t) {
          for (var e in t)
            Ut((i = e)) || D('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e),
                -1 !== Yt.indexOf(o) &&
                  D(
          ...
          _t.deferDisposalTimer &&
            (clearTimeout(_t.deferDisposalTimer), delete _t.deferDisposalTimer);
        var e = (function (t) {
